...
object ParquetReader {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      /* Clean up Master to ensure no duplicated records based on the Key column geogra@@phical_location_oid */
      ...
      val parquetFilePath_output = "C:/Users/josephlim/Downloads/output"
