error id: java/lang/Throwable#getMessage().
file:///C:/Users/josephlim/Projects/data-transformation/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol java/lang/Throwable#getMessage().
...
import org.apache.commons.io.FileUtils
  ...
  object ParquetReader {
    def main(args: Array[String]): Unit = {
      ...
      try {
        ...
        writeParquetFile(spark, rdd_report, rdd_report_ColNames, "parquetFilePath_output", sampleSize = 50)
  ...
  def readParquetFile(spark: SparkSession, filePath: String): (RDD[String], Seq[String]) = {
	...
	def writeParquetFile(spark: SparkSession, rdd: RDD[String], columnNames: Seq[String], filePath: String, sampleSize: Int = 100): Unit = {
	  // Parse the RDD[String] into RDD[(String, Any)]
	  ...
	  val rowRDD = parsedRDD.map(tuple => Row(tuple.productIterator.toSeq: _*))
