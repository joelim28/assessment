...
non-local guesses:
	 ...
	 -masterColumnNames#
	 -masterColumnNames().
	 -scala/Predef.masterColumnNames.
	 -scala/Predef.masterColumnNames#
	 -scala/Predef.masterColumnNames().
offset: 746
...
object ParquetReader {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      showTopRecords(rdd_master_stg1, rdd_mast@@er_ColNames_stg2, 11)  // Display top 11 records with header
    
      val (rdd_master_stg2, rdd_master_ColNames_stg2) = dedupeRDD(spark, rdd_master, masterColumnNames, Seq("geographical_location_oid"))
      showTopRecords(rdd_master_stg2, rdd_master_ColNames_stg2, 11)  // Display top 11 records with header
