...
object ParquetReader {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      val (rdd_trnx_stg2, rdd_trnx_ColNames_stg2) = dedupeRDDFirst(spark, rdd_master_stg1@@, rdd_master_ColNames_stg1, Seq("detection_oid"), Seq("timestamp_detected"))
      val (rdd_trnx_stg3) = filterRecords(rdd_trnx_stg2, rdd_trnx_ColNames_stg2, "valid_flag", "Y")
     /*
