...
non-local guesses:
	 -rdd_trnx_ColNames_stg3.
	 -rdd_trnx_ColNames_stg3#
	 -rdd_trnx_ColNames_stg3().
	 -scala/Predef.rdd_trnx_ColNames_stg3.
	 -scala/Predef.rdd_trnx_ColNames_stg3#
	 -scala/Predef.rdd_trnx_ColNames_stg3().
offset: 2113
...
object ParquetReader {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      showTopRecords(rdd_trnx_fnl, rdd_trnx_@@ColNames_stg3, 10)  // Check to ensure data is filtered correctly
