error id: _empty_/ParquetReader.showTopRecords().
file:///C:/Users/josephlim/Projects/data-transformation/src/main/scala/Main.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol _empty_/ParquetReader.showTopRecords().
...
object ParquetReader {
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      val leftJoinedRDD = leftJoinRDDs(deduped_rdd_trnx, deduped_rdd_master, 0, 0)

      showTopRecords(leftJoinedRDD, 10)  // Display top 10 records
    } catch {
